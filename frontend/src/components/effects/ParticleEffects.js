    ...
    class LightParticle {
      ...
      draw() {
        ...
        const outerGlow = ctx.createRadialGradient(
          this.x, this.y, 0,
          this.x, this.y, this.glowSize * pulseFactor // eslint-disable-line no-undef
        );
        ...
        ctx.beginPath();
        ctx.arc(this.x, this.y, this.glowSize * pulseFactor, 0, Math.PI * 2); // eslint-disable-line no-undef
        ctx.fill();
